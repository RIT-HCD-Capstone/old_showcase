<!-- copied from openlab-theme/sidebar-help.php -->
<!-- the purpose of this file is to override that -->
<!-- place the tag cloud before the contact-us link -->
<!-- replaced OpenLab in Conact-Us with DHSS Showcase -->
<!-- replace the Contact-Us link with a link to a contact form withint the help directory --> 
<?php /**
 * The Help Sidebar
 *
 */ ?>
...
<div class="sidebar-block padded-block">
<div id="support-team">
	<div class="help-tags-copy"><p>The Support Team is here to answer all your DHSS Showcase questions.</p></div>
	<?php
	$args     = array(
		'name'        => 'contact-us',
		'post_type'   => 'help',
	...
	?>
	<a class="btn btn-default btn-block btn-primary link-btn" href="https://dhssatrit.cad.rit.edu/blog/help/contact-us"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> <?php esc_html_e( 'Contact Us', 'commons-in-a-box' ); ?></a>
</div><!--support team-->
</div>
