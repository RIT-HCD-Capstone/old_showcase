<!-- this file overrides openlab-theme/parts/pages openlab-calendar-upcoming.php to include Event Proposal as a menu item -->
<?php $menu_items = calendar_submenu(); //this does that ?>
