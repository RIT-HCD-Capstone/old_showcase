<!-- yanked from openlab-theme/parts/sibebar/group.php -->
<!-- the purpose of the following code is to replace a call to openlab_get_group_activity_events_feed with a call to get_group_activity_events_feed, defined in functions.php -->
<?php
		...
		if ( bp_has_groups() ) :
			...
			<div class="sidebar-widget sidebar-widget-wrapper" id="portfolio-sidebar-widget">
				...
				<?php if ( ! cboxol_is_portfolio() ) : ?>
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					<?php echo /*openlab_get_group_activity_events_feed();*/ get_group_activity_events_feed(); /*this does that*/ ?>
				<?php endif; ?>
			</div>
					<?php
		endwhile;
