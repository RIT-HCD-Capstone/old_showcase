	...
	<div class="form-group">
		<?php if ( $show_open ) : ?>
			<div class="sidebar-filter-checkbox">
				<input type="checkbox" name="is_open" id="checkbox-is-open" <?php checked( $is_open ); ?> value="1" /> <label for="checkbox-is-open"><?php esc_html_e( 'Public', 'commons-in-a-box' ); ?></label>
			</div>
		<?php endif; ?>
