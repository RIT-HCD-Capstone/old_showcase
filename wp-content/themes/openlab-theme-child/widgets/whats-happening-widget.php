<!-- copied from openlab-theme/lib/widgets/whats-happening.php -->
<!-- the purpose of this file is to help replace 'WHAT'S HAPPENING?' with 'What's Happening?', integrated by functions.php -->
<?php
 ...
 * @since 1.0.0
 */
class OpenLab_Child_WhatsHappening_Widget extends WP_Widget {
