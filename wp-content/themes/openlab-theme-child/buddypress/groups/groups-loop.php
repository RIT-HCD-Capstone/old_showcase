	...
	<div class="row group-archive-header-row">
		...
		<?php elseif ( bp_is_groups_directory() || openlab_is_search_results_page() ) : ?>
			<div class="col-lg-19 col-md-18 col-sm-16">
                                <?php esc_html_e( 'You can use our search to find projects, classes, and DH tools. To learn about searching that content, visit ', 'commons-in-a-box' );?>
                                <a href="https://dhssatrit.cad.rit.edu/blog/help/help-category/search-help/">our related search page.</a>
                                <?php
