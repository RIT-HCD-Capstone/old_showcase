...
/* index-directory.php
 *
 * the purpose of this file is to provide the general structure of the member search-results page.
 *
 * @overrides openlab-theme/buddypress/members/index-directory.php
 *
 * @author OpenLab Team
