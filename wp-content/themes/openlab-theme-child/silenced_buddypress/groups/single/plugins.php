<!-- the purpose of this file is to replace 'View Docs' and 'New Doc' in the Posts (Docs) submenu with 'View Posts' and 'New Posts' -->
<?php
/**
	...
	<div class="row submenu-row"><div class="col-md-24">
			<div class="submenu">
				...
				<?php elseif ( bp_is_current_action( 'docs' ) ) : ?>
					...
					<ul class="nav nav-inline">
						<?php bp_get_template_part( 'groups/single/docs-tabs' ); //openlab_docs_tabs(); /*this does that*/ ?>
					</ul>
