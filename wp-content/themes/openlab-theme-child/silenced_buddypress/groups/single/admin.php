<!-- the purpose of this file is to replace 'Setup a site?' with 'Associate a site?' editing a project profile with no associate site for coherency with the prompt when creating a project profile. -->
<?php
global $bp;
...
<form action="<?php bp_group_admin_form_action(); ?>" name="group-settings-form" id="openlab-group-settings-form" class="standard-form form-panel" method="post" enctype="multipart/form-data">
	...
	<div class="item-body" id="group-create-body">
		...
		<?php if ( bp_is_group_admin_screen( 'site-details' ) ) : ?>
			...
			<?php bp_get_template_part( 'groups/site-markup' ); //openlab_group_site_markup(); /*this does that*/ ?>
