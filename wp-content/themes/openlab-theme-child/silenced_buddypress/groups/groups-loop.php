<!-- This file overrides bp_has_groups to remove the "Narrow down results using..." description from group pages. 
and replace it with specific descriptions for the Course and Project directory pages.
-->
<?php
/**
 * Group loop
	...
	<div class="row group-archive-header-row">
		...
		<?php elseif ( bp_is_groups_directory() || openlab_is_search_results_page() ) : ?>
			<div class="col-lg-19 col-md-18 col-sm-16">
				<?php //esc_html_e( 'Narrow down your results using the search filters.', 'commons-in-a-box' ); /*this does that*/
                                        if ( $group_args['group_type'] == 'project' ) {
                                                esc_html_e(
                                                        'These project profiles represent work by DHSS students, faculty' .
                                                        ', and collaborators, serving as both an archive and living document' .
                                                        ' of their efforts. They include capstone, course, research and personal' .
                                                        ' projects.'
                                                );
                                        }
                                        elseif ( $group_args['group_type'] == 'course' ) {
                                                esc_html_e(
                                                        'These course profiles represent the core DHSS curriculum and changes ' .
                                                        'to course offerings.' 
                                                );
                                        }
                                ?> 
