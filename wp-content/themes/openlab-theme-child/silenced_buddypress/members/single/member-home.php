<!-- the purpose of this file is to remove the course, community, and project highlights from member profiles. -->
<?php
/**
...
<div id="member-item-body" class="row">
	...
	<?php foreach ( $group_types as $group_type ) : ?>
		...
		<?php //echo openlab_profile_group_type_activity_block( $group_type ); /*  this does that*/ ?>
	<?php endforeach; ?>
