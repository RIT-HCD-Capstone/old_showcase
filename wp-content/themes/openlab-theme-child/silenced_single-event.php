<!-- copied from openlab-theme/single-event.php -->
<!-- the following code prevents the About sidebar from loading on single event pages -->
<?php
/**
...
<div id="content" class="hfeed row">
			...
			<div id="item-body">
				<div class="submenu">
					...
					<ul class="nav nav-inline"><!--
						<?php $menu_items = openlab_calendar_submenu(); //calendar_submenu(); ?>
	...
	<?php //get_template_part( 'parts/sidebar/about' ); /*this does that*/ ?>
